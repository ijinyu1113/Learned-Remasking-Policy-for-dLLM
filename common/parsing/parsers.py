...
class Parser:
    ...
    def extract_answer_gsm8k(cls, generated_text):
        ...
        :param generated_text: Generated text containing #### delimiter
        :return: Extracted float answer, or None if no valid answer found
        """
        try:
    ...
    def extract_answer_boxed(cls, generated_text):
        ...
        :param generated_text: Generated text containing \\boxed{} notation
